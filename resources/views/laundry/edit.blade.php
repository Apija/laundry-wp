                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control @error('id_layanan') is-invalid @enderror"
                                            id="id_layanan" name="id_layanan" value="{{ old('id_layanan') }}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control @error('berat') is-invalid @enderror"
                                            id="berat" name="berat" value="{{ old('berat', $id->berat) }}"
                                            oninput="updateHarga()">
                                        @error('berat')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control @error('status') is-invalid @enderror" id="status"
                                            ...
                                            <option value="Sedang dalam proses" @selected($id->status == 'Sedang dalam proses')>Sedang dalam
                                                proses</option>
                                            <option value="Sudah selesai" @selected($id->status == 'Sudah selesai')>Sudah Selesai
                                            </option>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date"
                                            ...
                                            name="tgl_selesai" value="{{ $id->tgl_selesai }}">
                                        @error('tgl_selesai')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
